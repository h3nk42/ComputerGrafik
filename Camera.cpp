...
{
	Position = newPosition +  (-0.1f * Orientation);
}
...
void Camera::Inputs(GLFWwindow* window)
{
	...
	//	if (abs(glm::angle(newOrientationVertical, Up) - glm::radians(90.0f)) <= glm::radians(20.0f))
	//	{
	...
	//	if (abs(glm::angle(newOrientationHorizontal, Up) - glm::radians(90.0f)) <= glm::radians(20.0f)) {
